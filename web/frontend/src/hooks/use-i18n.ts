...
const strings = {
  ...
  "reader.analyze": { zh: "章节分析", en: "Analyze Chapter" },
  "reader.analyzing": { zh: "分析中...", en: "Analyzing..." },
  "reader.analysis": { zh: "章节分析", en: "Chapter Analysis" },
  "reader.analysisHint": { zh: "按需调用 observer 与 reflector，检查本章会如何推进状态。", en: "Run observer and reflector on demand to inspect the state transition for this chapter." },
  "reader.analysisEmpty": { zh: "点击“章节分析”查看 facts、delta 和状态推进。", en: "Click Analyze Chapter to inspect facts, delta, and state transition." },
  "reader.facts": { zh: "事实", en: "Facts" },
  "reader.newHooks": { zh: "新钩子", en: "New Hooks" },
  "reader.subplots": { zh: "子线更新", en: "Subplots" },
  "reader.emotionalArcs": { zh: "情绪弧", en: "Emotional Arcs" },
  "reader.characterMatrix": { zh: "角色矩阵", en: "Character Matrix" },
  "reader.stateTransition": { zh: "状态推进", en: "State Transition" },
  "reader.previousSummary": { zh: "前章摘要", en: "Previous Summary" },
  "reader.deltaPreview": { zh: "Delta 预览", en: "Delta Preview" },
  "reader.ready": { zh: "已生成", en: "Ready" },
  "reader.pending": { zh: "待生成", en: "Pending" },
  ...
  "create.brief": { zh: "故事简介 / 创作意图", en: "Story Brief / Intent" },
  "create.briefPlaceholder": { zh: "写几句背景、主线冲突、主角目标或你想先生成的设定。留空时会由已配置的 LLM 根据书名和题材补全创作意图。", en: "Add a few lines about the premise, conflict, protagonist goal, or the setup you want generated first. If left blank, the configured LLM will infer a starting brief from the title and genre." },
  ...
  "create.llmWarning": { zh: "当前 LLM 连接不可用。创建书籍前必须先完成模型配置并确认连通。", en: "LLM connectivity is unavailable. Configure a reachable model before creating a book." },
  "create.llmRequired": { zh: "当前 LLM 连接不可用，无法创建书籍。请先配置并连通模型。", en: "LLM connectivity is unavailable, so the book cannot be created yet. Configure and connect a model first." },
  "create.llmFallback": { zh: "本次创建未连通 LLM，已使用兜底初始化资料。背景设定和真相文件可能不完整，建议修复模型连接后再补生成。", en: "This book was created without a live LLM connection, so fallback bootstrap data was used. The background setup and truth files may be incomplete until the model connection is fixed." },
  "create.llmFallbackAlert": { zh: "本次创建未连通 LLM，已使用兜底初始化资料。请检查模型配置后，再补生成背景信息。", en: "This book was created with fallback bootstrap data because the LLM connection was unavailable. Check the model configuration, then regenerate the background details." },
  ...
  "book.statusDraft": { zh: "草稿中", en: "Draft" },
  ...
  "book.statusArchived": { zh: "已归档", en: "Archived" },
  "book.statusDropped": { zh: "已放弃", en: "Dropped" },
  "book.truthFiles": { zh: "真相文件", en: "Truth Files" },
  "book.foundationReady": { zh: "初始化资料", en: "Bootstrap" },
  "book.foundationSummary": { zh: "创建书籍时生成的背景设定、真相文件和起步焦点。", en: "Background setup, truth files, and opening focus generated during book creation." },
  "book.bootstrapSource": { zh: "生成来源", en: "Source" },
  "book.currentFocus": { zh: "当前焦点", en: "Current Focus" },
  "book.openHooks": { zh: "开放钩子", en: "Open Hooks" },
  "book.foundationBrief": { zh: "创作意图", en: "Author Intent" },
  "book.foundationConflict": { zh: "核心冲突", en: "Core Conflict" },
  "book.foundationWorld": { zh: "世界锚点", en: "World Anchor" },
  "book.foundationArtifacts": { zh: "基础产物", en: "Foundation Artifacts" },
  "book.viewEdit": { zh: "查看/编辑", en: "View/Edit" },
  ...
  "doctor.configJson": { zh: "StoryForge 配置", en: "StoryForge configuration" },
  "doctor.projectEnv": { zh: "项目 .env 文件", en: "Project .env file" },
  "doctor.globalEnv": { zh: "全局 ~/.storyforge/.env", en: "Global ~/.storyforge/.env" },
  ...
  "daemon.subtitle": { zh: "查看调度器是否在线、当前容量、最近调度与后台章节流水线状态。", en: "Monitor scheduler health, capacity, recent scheduling, and background chapter pipelines." },
  "daemon.running": { zh: "运行中", en: "Running" },
  "daemon.stopped": { zh: "已停止", en: "Stopped" },
  "daemon.start": { zh: "启动", en: "Start" },
  "daemon.stop": { zh: "停止", en: "Stop" },
  "daemon.pollNow": { zh: "立即轮询", en: "Poll Now" },
  ...
  "daemon.liveEventLog": { zh: "实时事件流", en: "Live Event Stream" },
  "daemon.status": { zh: "状态", en: "Status" },
  "daemon.mode": { zh: "模式", en: "Mode" },
  "daemon.activeBooks": { zh: "活跃书籍", en: "Active Books" },
  "daemon.activeBooksHint": { zh: "进行中 / 全部书籍", en: "Active / total books" },
  "daemon.inFlight": { zh: "执行中 / 排队", en: "Running / Queued" },
  "daemon.runningQueued": { zh: "当前运行和等待的 run", en: "Current running and waiting runs" },
  "daemon.schedulerRuns": { zh: "调度 run", en: "Scheduler Runs" },
  "daemon.capacity": { zh: "并发容量", en: "Capacity" },
  "daemon.schedulerState": { zh: "调度器状态", en: "Scheduler State" },
  "daemon.tick": { zh: "轮询", en: "Tick" },
  "daemon.startedAt": { zh: "启动时间", en: "Started At" },
  "daemon.lastPollAt": { zh: "最近轮询", en: "Last Poll" },
  "daemon.pollInterval": { zh: "轮询间隔", en: "Poll Interval" },
  "daemon.latestSchedule": { zh: "最近调度", en: "Latest Schedule" },
  "daemon.noScheduleYet": { zh: "暂无调度记录", en: "No schedule yet" },
  "daemon.succeeded": { zh: "成功", en: "Succeeded" },
  "daemon.failed": { zh: "失败", en: "Failed" },
  "daemon.cancelled": { zh: "已取消", en: "Cancelled" },
  "daemon.queued": { zh: "排队", en: "Queued" },
  "daemon.recentDaemonEvents": { zh: "最近守护进程事件", en: "Recent Daemon Events" },
  "daemon.event": { zh: "事件", en: "Event" },
  ...
  "chapter.revised": { zh: "已修订", en: "Revised" },
  "chapter.rejected": { zh: "已驳回", en: "Rejected" },
  "chapter.audited": { zh: "已审计", en: "Audited" },
